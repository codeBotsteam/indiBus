...
const PlanTrip = () => {
  return (
    <section className="flex-1 flex flex-col items-center justify-center px-4 py-12">
      <h2 className="text-3xl font-bold text-green-700 mb-4 dark:text-green-300">Plan Your Bus Trip</h2>
      <p className="text-lg max-w-xl text-gray-700 mb-6 dark:text-white">Find the best government bus routes, schedules, fares, operators and eco scores for your journey, and visualize your trip across India.</p>
